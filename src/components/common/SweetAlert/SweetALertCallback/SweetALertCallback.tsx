  ...
  return (
    <React.Fragment>
      <SweetAlert
        ...
        showCancel
        reverseButtons
        customClass={Styled["custom-modal"]}
        confirmBtnCssClass={Styled["custom-confirm-btn"]}
        cancelBtnCssClass={Styled["custom-cancel-btn"]}
        confirmBtnStyle={{
          backgroundColor: "#d29f58 !important",
          borderColor: "#d29f58 !important",
        }}
        confirmBtnText="بله"
        cancelBtnText="خیر"
        onConfirm={onConfirm}
